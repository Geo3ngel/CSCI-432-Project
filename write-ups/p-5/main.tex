...
\begin{document}
   ...
   At this stage, we are planning to have Tommy do the voice over for the video demonstration of the Burrows-Wheeler transform. In the video, that we have yet to record, we plan to show the code and the output of our implementation of the Burrows-Wheeler transform.
